<template>
    <div>
        <h1 class="text-4xl font-bold mb-6">Haftungsausschluss</h1>

        <h3 class="text-2xl font-semibold mb-3">Haftung für Inhalte</h3>
        ...
        <h3 class="text-2xl font-semibold mb-3">Haftung für Links</h3>
        <p class="text-base mb-6">Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb
        ...
        <h3 class="text-2xl font-semibold mb-3">Urheberrecht</h3>
