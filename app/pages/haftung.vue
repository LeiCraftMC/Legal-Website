<template>
    <h1 class="text-4xl font-bold mb-4">Haftungsausschluss</h1>
    <br>
    <h3 class="text-2xl font-semibold mb-2">Haftung für Inhalte</h3>
    <p class="text-base mb-4">Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit und
    ...
    <br>
    <h3 class="text-2xl font-semibold mb-2">Haftung für Links</h3>
    <p class="text-base mb-4"> Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb
    ...
    <br>
    <h3 class="text-2xl font-semibold mb-2">Urheberrecht</h3>
    <p class="text-base mb-4">Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen
